    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OutgoingInvoice", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OutgoingInvoice_Customer_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OutgoingInvoice_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TotalDiff = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedBy = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservedQty = table.Column<decimal>(type: "decimal(18,2)", nullable: false, defaultValue: 0m),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OutgoingLine", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OutgoingLine_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OutgoingLine_OutgoingInvoice_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "OutgoingInvoice",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InventoryLine", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InventoryLine_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    StockBalanceId = table.Column<long>(type: "bigint", nullable: false),
                    OrderId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpiryDate = table.Column<DateOnly>(type: "date", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    RefDocId = table.Column<int>(type: "int", nullable: true),
                    RefDocType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ItemId = table.Column<int>(type: "int", nullable: false),
                    WarehouseId = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<int>(type: "int", nullable: false),
                    StockBalanceId = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Transactions_StockBalances_StockBalanceId",
                        column: x => x.StockBalanceId,
                        principalTable: "StockBalances",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryLine_InventoryId",
                table: "InventoryLine",
                column: "InventoryId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryLine_ItemId",
                table: "InventoryLine",
                column: "ItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OutgoingInvoice_CustomerId",
                table: "OutgoingInvoice",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_OutgoingInvoice_UserId",
                table: "OutgoingInvoice",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_OutgoingLine_InvoiceId",
                table: "OutgoingLine",
                column: "InvoiceId");

            migrationBuilder.CreateIndex(
                name: "IX_OutgoingLine_ItemId",
                table: "OutgoingLine",
                column: "ItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_StockBalanceId",
                table: "Transactions",
                column: "StockBalanceId");
